...
namespace EasyEngine {
    NormalmapTesting::NormalmapTesting(const std::string& shaderPath):RenderPass(shaderPath){}
    void NormalmapTesting::initialize(){
        ...
        cubeTexture = make_shared<Texture>(PU::getFullPath(g_global_context.m_config_manager->getTextureFolder(), "brick/diffuse.bmp"));
        cubenormalTexture = make_shared<Texture>(PU::getFullPath(g_global_context.m_config_manager->getTextureFolder(), "brick/normal.bmp"));
    ...
    glm::mat2x3 NormalmapTesting::getTB(glm::vec3 pos1,glm::vec3 pos2, glm::vec3 pos3 ,glm::vec2 uv1, glm::vec2 uv2, glm::vec2 uv3){
        glm::vec3 edge1 = pos2 - pos1;
        glm::vec3 edge2 = pos3 - pos1;
        glm::vec2 deltaUV1 = uv2 - uv1;
        glm::vec2 deltaUV2 = uv3 - uv1;
        ...
        glm::mat2 deltaMat(deltaUV2.y,deltaUV2.x,-deltaUV1.y,deltaUV1.x);
        glm::mat2x3 E(edge1,edge2);
        glm::mat2x3 TB = E*deltaMat;
        return TB;
    }

    void NormalmapTesting::draw(Camera& camera){
         // cubes
        glBindVertexArray(cubeVAO);
        ...
        lightPos = glm::vec3(2*cos(WindowTime::currentTimeValue),0,2*sin(WindowTime::currentTimeValue));
    ...
    NormalmapTesting::~NormalmapTesting(){
