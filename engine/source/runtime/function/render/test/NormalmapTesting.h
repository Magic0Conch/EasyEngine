...
namespace EasyEngine {
    class NormalmapTesting:public RenderPass{
        private:            
        ...
        public:
            ...
            shared_ptr<Texture> cubeTexture,cubenormalTexture;

            NormalmapTesting(const std::string& shaderPath);
            virtual void draw(Camera& camera);
            virtual void initialize();
            virtual ~NormalmapTesting();
