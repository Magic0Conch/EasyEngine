...
// const string triangleShaderVert = "shader/triangle_shader.vert";
// const string triangleShaderFrag = "shader/triangle_shader.frag";
...
int main(int argc,char** argv) {
	...
	//create the window
	window = glfwCreateWindow(viewportWidth, viewportHeight,  "Rasterization", NULL, NULL);//window witdth,height,name
	if (window == NULL) {
